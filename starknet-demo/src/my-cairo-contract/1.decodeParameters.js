...
const { constants, Contract, Account, json, shortString, RpcProvider, types, RPC, num, ec, CallData, hash, cairo, AbiEntry, Result } = require("starknet");
const fs = require("fs") ;
...
async function main() {
    ...
    console.log("helloCallData =", helloCallData);
    console.log("helloCallData2 =", helloCallData2);
    console.log("cairo0CallData =", cairo0CallData);
    console.log("hello0CallData =", hello0CallData);
