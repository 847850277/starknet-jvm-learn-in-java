...
public final class Uint64 extends NumAsHexBase implements ConvertibleToCalldata {
    ...
    public String toString() {
        return "Uint64(" + ToHexKt.toHex(this.getValue()) + ')';
    }
    ...
    public Uint64(@NotNull BigInteger value) {
        super(value, (DefaultConstructorMarker)null);
        Intrinsics.checkNotNullParameter(value, "value");
        this.value = value;
        if (this.getValue().compareTo(BigInteger.ZERO) < 0) {
            try {
                throw (Throwable)(new IllegalArgumentException("Default Uint64 constructor does not accept negative numbers, [" + this.getValue() + "] given."));
            } catch (Throwable e) {
                throw new RuntimeException(e);
            }
        } else if (this.getValue().compareTo(MAX) >= 0) {
            try {
                throw (Throwable)(new IllegalArgumentException("Default Uint64 constructor does not accept numbers higher than 2^64-1, [" + this.getValue() + "] given."));
            } catch (Throwable e) {
                throw new RuntimeException(e);
            }
        }
...
//    }
    ...
    static {
        BigInteger var10000 = BigInteger.valueOf(2L).pow(64);
        Intrinsics.checkNotNullExpressionValue(var10000, "BigInteger.valueOf(2).pow(64)");
    ...
    @NotNull
    public final Uint64 copy(@NotNull BigInteger value) {
        Intrinsics.checkNotNullParameter(value, "value");
        return new Uint64(value);
    }

    // $FF: synthetic method
    public static Uint64 copy$default(Uint64 var0, BigInteger var1, int var2, Object var3) {
        if ((var2 & 1) != 0) {
            var1 = var0.getValue();
        }
    ...
    public boolean equals(@Nullable Object var1) {
        if (this != var1) {
            if (var1 instanceof Uint64) {
                Uint64 var2 = (Uint64)var1;
    ...
    @JvmStatic
    @NotNull
    public static final Uint64 fromHex(@NotNull String value) {
    ...
    @Metadata(
            ...
            d2 = {"Lcom/swmansion/starknet/data/types/Uint64$Companion;", "", "()V", "MAX", "Ljava/math/BigInteger;", "ONE", "Lcom/swmansion/starknet/data/types/Uint64;", "ZERO", "fromHex", "value", "", "serializer", "Lkotlinx/serialization/KSerializer;", "starknet-jvm-learn"}
    )
    public static final class Companion {
        @JvmStatic
        @NotNull
        public final Uint64 fromHex(@NotNull String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            return new Uint64(ParseHex.parseHex(value));
        }
        ...
        public final KSerializer serializer() {
            return null;
            //return (KSerializer)Uint64Serializer.INSTANCE;
        }
    }
}
