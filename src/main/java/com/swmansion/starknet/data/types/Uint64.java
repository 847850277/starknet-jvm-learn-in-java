...
public final class Uint64 extends NumAsHexBase implements ConvertibleToCalldata {
    ...
    public Uint64(@NotNull BigInteger value) {
        ...
        if (this.getValue().compareTo(BigInteger.ZERO) < 0) {
                throw new IllegalArgumentException("Default Uint64 constructor does not accept negative numbers, [" + this.getValue() + "] given.");
        } else if (this.getValue().compareTo(MAX) >= 0) {
                throw new IllegalArgumentException("Default Uint64 constructor does not accept numbers higher than 2^64-1, [" + this.getValue() + "] given.");
        }
    }
